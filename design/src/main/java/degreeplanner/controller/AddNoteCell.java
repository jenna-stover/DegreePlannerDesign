...
public class AddNoteCell extends TableCell<Student, Boolean> {
    ...
    public AddNoteCell(FacultyHomeController facultyHomeController) {
        this.facultyHomeController = facultyHomeController;
        addNoteButton = new Button("Add Note");
        addNoteButton.setOnAction(event -> {
            Student student = getTableView().getItems().get(getIndex());
            Dialog<Pair<String, LocalDate>> dialog = new Dialog<>();
...
// public void updateItem(Boolean item, boolean empty) {
//     super.updateItem(item, empty);
//     setGraphic(addNoteButton); // Always set the button as the graphic
// }

    // public static Callback<TableColumn<Student, Boolean>, TableCell<Student, Boolean>> forTableColumn() {
    //     return param -> new AddNoteCell();
    // }
    public static Callback<TableColumn<Student, Boolean>, TableCell<Student, Boolean>> forTableColumn(FacultyHomeController facultyHomeController) {
        return param -> new AddNoteCell(facultyHomeController);
    }
}
